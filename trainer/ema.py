"""PyTorch Lightning callback for exponential moving average weights.

EMA keeps a smoothed copy of model parameters during training. Validation can
temporarily use the EMA weights, then restore the live training weights.
"""
